...
1. Short cardiac catheterization case conference, with a focus on [three PCI cases](https://asshah4.github.io/clinical/cases/03-16-21_cath-case-conference/cath-case-conference.html).
1. Short cardiac catheterization case conference, with a focus on [STEMI from call](https://asshah4.github.io/clinical/cases/06-01-21_cath-case-conference/cath-case-conference.html).
1. Short cardiac catheterization case conference, with a focus on [CABG revascularization](https://asshah4.github.io/clinical/cases/09-21-21_cath-case-conference/cath-case-conference.html)
1. Short cardiac catheterization case conference, with a focus on [severe disease](https://asshah4.github.io/clinical/cases/09-28-21_cath-case-conference/cath-case-conference.html)
1. An introduction to [femoral access](https://asshah4.github.io/clinical/talks/09-28-21_femoral-access/femoral-access.html)
