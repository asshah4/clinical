...
## {background-image="tmf_data/ecg-case-svt-old.png" background-size="contain"}
...
```{r}
#| cache: true
x <- read_lspro(file.path(loc, "tmf_data/m3916-svt-initiation.txt"))
...
```{r}
#| cache: true
x <- read_lspro(file.path(loc, "tmf_data/m3916-avn-erp-s1-600ms-s2-220ms.txt"))
