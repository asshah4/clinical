...
## Differential for regular / short RP tachycardia
...
| RAAS | Appears that there is retrograde conduction |
...
#| cache: true
#| fig-cap: PVC however affected the HH interval, thus not refractory, and we get fusion beat
ggm(data = his_pvc_fail,
		channels = c("I", "CS", "HIS", "RV"),
