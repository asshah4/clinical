...
ra <-
	...
	geom_sf(data = septum,
					fill = grey[5],
					alpha = 0.5) +
	geom_sf(data = chambers[chambers$view == "cross",],
					fill = grey[1],
					alpha = 0.2) +
	geom_sf(data = septum[septum$view == "cross",],
					fill = grey[1],
					alpha = 0.2) +
	geom_sf(data = vessels[vessels$type == "venous",],
					fill = blue[1],
					alpha = 0.7) +
	geom_sf(data = vessels[vessels$type == "arterial",],
					fill = red[1],
					alpha = 0.7) +
	geom_sf(data = valves,
					fill = grey[9],
...
#| output-location: fragment
ra +
	geom_sf(data = conduction, fill = orange[2], alpha = 0.9) +
	geom_sf_label(data = conduction, aes(label = label)) 
```
