...
```{r}
ra <- coraline::cardiac_atlas$right_atrium_rao

ggplot() +
	geom_sf(data = ra$chambers) +
	geom_sf(data = ra$vessels) +
	geom_sf(data = ra$projections) +
	geom_sf(data = ra$valves) +
	geom_sf(data = ra$septum) +
	geom_sf(data = ra$conduction) +
	theme_void()
